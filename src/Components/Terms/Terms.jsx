    ...
    <div>
      <section className={styles.termsSection}>
        ...
        <ul>
          ...
          <li>
            Candidates will receive interview calls from different job portals.
          </li>
          ...
          <li>
            All candidates are expected to maintain professional behavior during
            training.
          </li>
          ...
          <li>
            Nexus is not liable for any damages arising from the use of its
            training services.
          </li>
        </ul>
        <br />
        ...
        <br />
        <p>
          If you have any queries or doubts regarding payment, please contact us
          at contact@Nexus-CTC-LLP
        </p>
      </section>
    </div>
  );
